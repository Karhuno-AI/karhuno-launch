...
import { Headset, Radar, BarChart, Megaphone, Briefcase, Search, User, Clock, Search as MagnifyingGlass } from 'lucide-react';
...
const WhoItsFor: React.FC = () => {
      ...
      entries.forEach((entry) => {
        if (entry.isIntersecting) {
          ...
          if (index >= 0) {
            ...
            connectorsRef.current[index]?.classList.add('h-full', 'opacity-100');
          }
        }
      });
    };
  ...
  const cards = [
    {
      ...
      description: "Stop sending cold emails to random lists. Reach out when companies show signs of buying — on LinkedIn or across the web.",
      bgColor: "bg-[#99edcd]",
    ...
    },
    {
      ...
      description: "Align campaigns with real market movement — like funding rounds or pain-point posts on LinkedIn.",
      bgColor: "bg-[#d8c4f4]",
    ...
    {
      title: "For Agencies",
      description: "Spot signals like \"need help with SEO\" or \"scaling outbound\" — and get to the client before your competitors do.",
      bgColor: "bg-[#f5f5f5]",
    ...
    },
    {
      ...
      description: "No sales team? No problem. We'll show you when the timing is right — and who's ready.",
      bgColor: "bg-[#99edcd]",
      borderColor: "border-[#49937d]",
      side: "right",
      icons: (
    ...
    },
    {
      ...
      description: "See who's hiring or scaling — before job boards even know. Get early access to talent and decision-makers.",
      bgColor: "bg-[#d8c4f4]",
      borderColor: "border-[#792abf]",
      side: "left",
      icons: (
  ...
  return (
    <section id="who-its-for" ref={sectionRef} className="py-16 px-6 md:px-12 bg-white relative overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 font-roboto">Who It&apos;s For</h2>
        </div>
        
        {/* Vertical Timeline Line - even shorter to prevent overlap with CTA */}
        <div className="absolute left-1/2 top-44 bottom-[450px] transform -translate-x-1/2 w-1 bg-[#a947e7] bg-opacity-80 z-10"></div>
              ...
              <div className="flex justify-center items-center">
                ...
                >
                  <div className="flex items-center mb-3">
                    ...
                    <h3 className="text-lg font-bold font-roboto text-[#222]">{card.title}</h3>
                  </div>
                  <p className="text-sm text-gray-700 font-montserrat">{card.description}</p>
                </div>
              </div>
        ...
        <div className="text-center mt-16 max-w-2xl mx-auto px-4 relative z-20 bg-[#F1F0FB] py-8 rounded-xl shadow-sm">
          <div className="mb-5">
            ...
            <p className="text-gray-600 font-montserrat">
              Join hundreds of sales professionals already using Karhuno to get ahead of competitors
            </p>
          </div>
