...
export function CookieConsent() {
  ...
  return (
    <>
      ...
      {showBanner && (
        <div className="fixed bottom-0 block left-0 w-[30%] z-50 p-4 bg-background border shadow-lg rounded-lg">
            ...
            <div className="flex flex-col space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <div className="bg-primary/10 text-primary text-xs px-2 py-1 rounded">Required</div>
                </div>
